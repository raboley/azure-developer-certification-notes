...
public class EventProcessorSample
{
    public static void main(String args[]) throws InterruptedException, ExecutionException
    {
    	...
    	String namespaceName = "rablabeventhub";
    	String eventHubName = "rablabhub";
    	String sasKeyName = "RootManageSharedAccessKey";
    	String sasKey = "1dWMzR3qJnJYRCRQh/Q5otTyiFnshEAfJ9WvlQk4Ano=";
    	String storageConnectionString = "DefaultEndpointsProtocol=https;EndpointSuffix=core.windows.net;AccountName=rabeventstorage;AccountKey=T7b/yWPECiOmtaqg3ps5Osi0m3By7Cv/jtwB/ihi/SlVhw0xzpGSuV+srzpWPmAztmHespR+JsY9wIqskO6/Xw==";
    	String storageContainerName = "messages";
    	String hostNamePrefix = "rabeventstorage";
